...
function queryAccBalance() {
    ...
    $.ajax({
        url: 'http://127.0.0.1:3004/checkAccBal/'+ $('#securities_id_a').val() + '/' + $('#query_bank1').val()  + '/'  + acc,
        type: "GET",
        async: false,
        dataType: "text",
...
function queryBanner() {
    ...
    // transferTo/Bank2/:amount//:frombank/:tobank/:fromacc/:toacc'
    $.ajax({
        url: 'http://127.0.0.1:3004/checkBanner/'+ $('#securities_id_a').val() + '/Bank5/' + $('#customer_id').val(),
        type: "GET",
        async: false,
        dataType: "text",
        complete: function (data) {
    ...
    if(PROCESS_MODE == "EZ") {
        ...
        $.ajax({
            url: 'http://127.0.0.1:3000/checkCBBalance/Bank5',
            type: "GET",
            async: false,
            dataType: "text",
            complete: function (data) {
...
function showTxnTable1() {
    ...
    var htmlstr = '<table class=\"fancytable_2\">' +
        ...
        '            <label class=\"label_2\">【轉出方銀行】</label><input id=\"from_bank_1\" type=\"text\" value=\"Bank5\" readonly/>' +
...
function showTxnTable2() {
    ...
    var htmlstr = '<table class=\"fancytable_2\">' +
        ...
        '        <td style=\"text-align: left; padding: 10px\" size=\"600\">' +
        '            <label class=\"label_2\">【轉入方銀行】</label><input id=\"to_bank_2\" type=\"text\" value="Bank5" readonly/>' +
...
function showTxnTable3() {
    ...
    var htmlstr = '<table class=\"fancytable_2\">' +
        ...
        '        <td style=\"text-align: left; padding: 10px\" size=\"600\">' +
        '            <label class=\"label_2\">【轉出方銀行】</label><input id=\"from_bank_3\" type=\"text\" value=\"Bank5\" readonly/>' +
        ...
        '        </td>' +
        '        <td class=\"dataroweven\" style="text-align: left; padding : 10px" size="100">' +
        '            <label class=\"label_2\">【轉入方銀行】</label><input NAME=\"to_bank_3\" id=\"to_bank_3\" value=\"Bank5\" readonly/><br/>' +
...
function showTxnTable4() {
    ...
    var htmlstr = '<table class=\"fancytable_2\">' +
        ...
        '        <td style=\"text-align: left; padding: 10px\" size=\"600\">' +
        '            <label class=\"label_2\">【轉入方銀行】</label><input id=\"to_bank_4\" type=\"text\" value=\"Bank5\" readonly/>' +
        ...
        '        </td>' +
        '        <td class=\"dataroweven\" style="text-align: left; padding: 10px" size="100">' +
        '            <label class=\"label_2\">【轉出方銀行】</label><input NAME=\"from_bank_4\" id=\"from_bank_4\" value=\"Bank5\" readonly /><br/>' +
...
function showTxnTable5() {
    ...
    var htmlstr = '<table class=\"fancytable_2\">' +
        ...
        '            <label class=\"label_2\">【銀行代號】</label><input id=\"to_bank_5\" type=\"text\" value=\"Bank5\" readonly/>' +
...
function showTxnTable6() {
    ...
    var htmlstr = '<table class=\"fancytable_2\">' +
        ...
        '        <td style=\"text-align: left; padding: 10px; padding: 10px\" size=\"600\">' +
        '            <label class=\"label_2\">【銀行代號】</label><input id=\"to_bank_6\" type=\"text\" value=\"Bank5\" readonly/>' +
        ...
        for (var y = 0; y < qry_pnd_data_array.length; y++) {
                ...
                tmp_array["securities_id"] == qry_pnd_data_array[y]["securities_id"] )
            {
                ...
                if(tmp_array["causer"] != "InputErr") {
                    ...
                    //alert(JSON.stringify(qry_err_data_array));
...
function qryTxnTable2() {
    ...
    var arrayStr = $.ajax({
        type: "GET",
        url: 'http://127.0.0.1:3004/checkTxnInfo/'+qry_string,
        async: false
    }).responseText;
...
function purchaseBond1() {
    ...
    var submitAjax = function() {
        ...
        alert('http://127.0.0.1:3004/purchaseBond/Bank5/S/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/' + rev_txnseq + '/' + rev_reason );

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/purchaseBond/Bank5/S/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/' + rev_txnseq + '/' + rev_reason ,
...
function purchaseBond2() {
    ...
    var submitAjax = function() {
        ...
        //'/purchaseBond/Bank2/:frombank/:fromcustomer/:tobank/:tocustomer/:amount/:securities_id/:payment'
        alert('http://127.0.0.1:3004/purchaseBond/Bank5/B/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/'+ rev_txnseq + '/' + rev_reason );

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/purchaseBond/Bank5/B/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/' + rev_txnseq + '/' + rev_reason ,
...
function purchaseBond3() {
    ...
    var submitAjax = function() {
        ...
        //'/purchaseBond/Bank2/:frombank/:fromcustomer/:tobank/:tocustomer/:amount/:securities_id/:payment'
        alert('http://127.0.0.1:3004/purchaseBond_N/Bank5/S/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/'+ rev_txnseq + '/' + rev_reason );

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/purchaseBond_N/Bank5/S/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/'+ rev_txnseq + '/' + rev_reason ,
...
function purchaseBond4() {
    ...
    var submitAjax = function() {
        ...
        //'/purchaseBond/Bank2/:frombank/:fromcustomer/:tobank/:tocustomer/:amount/:securities_id/:payment'
        alert('http://127.0.0.1:3004/purchaseBond_N/Bank5/B/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/'+ rev_txnseq + '/' + rev_reason );

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/purchaseBond_N/Bank5/B/'+from_bank+'/'+ from_customer + '/' + to_bank +'/'+
            to_customer +'/'+ amount +'/'+ securities_id +'/'+ payment + '/'+ rev_txnseq + '/' + rev_reason ,
...
function setCustomerInfo() {
    ...
    var submitAjax = function() {
        ...
        //'/purchaseBond/Bank2/:frombank/:fromcustomer/:tobank/:tocustomer/:amount/:securities_id/:payment'
        alert('http://127.0.0.1:3004/setCustomerInfo/Bank5/'+ to_customer +'/' + to_name + '/' + to_type);

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/setCustomerInfo/Bank5/'+ to_customer +'/' + to_name + '/' + to_type,
...
function depositCBBalance() {
    ...
    var submitAjax = function() {
        ...
        //'/purchaseBond/Bank2/:frombank/:fromcustomer/:tobank/:tocustomer/:amount/:securities_id/:payment'
        alert('http://127.0.0.1:3000/depositCBBalance/Bank5/'+ cb_balance);

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3000/depositCBBalance/Bank5/'+ cb_balance,
...
function depositDLTBalance() {
    ...
    var submitAjax = function() {
        ...
        //'/purchaseBond/Bank2/:frombank/:fromcustomer/:tobank/:tocustomer/:amount/:securities_id/:payment'
        alert('http://127.0.0.1:3004/depositDLTBalance/Bank5/'+ dlt_acc + '/'  + dlt_balance);

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/depositDLTBalance/Bank5/'+ dlt_acc + '/'  + dlt_balance,
...
function switchMode() {
    ...
    var submitAjax = function() {
        ...
        alert('http://127.0.0.1:3004/switchMode/Bank5/'+ process_mode + "/" + process_timeout);

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/switchMode/Bank5/'+ process_mode + "/" + process_timeout,
...
function testMode() {
    ...
    var submitAjax = function() {
        ...
        alert('http://127.0.0.1:3004/testMode/'+ test_mode + "/" + test_bank + "/" + test_type + "/" + test_period + "/" + test_flag);

        // 使用 ajax() 來呼叫 REST API
        return $.ajax({
            url: 'http://127.0.0.1:3004/testMode/'+ test_mode + "/" + test_bank + "/" + test_type + "/" + test_period + "/" + test_flag,
...
function unlockAccount() {
    ...
    var submitAjax2 = function() {
        ...
        //
        $.ajax({
            url: 'http://127.0.0.1:3004/unlockAccount/'+ _password + '/' + _period,
            type: "GET",
            async: false,
            dataType: "text",
...
function lockAccount() {
    ...
    var submitAjax2 = function() {
        ...
        //
        $.ajax({
            url: 'http://127.0.0.1:3004/lockAccount',
            type: "GET",
            async: false,
            dataType: "text",
            complete: function (data) {
...
function cancelTransactions() {
    ...
    for(var i=0; i<selected_raw_array.length; i++) {
        ...
        var submitAjax2 = function() {
            ...
            //
            $.ajax({
                url: 'http://127.0.0.1:3004/cancelTransaction/'+ _from_bank + '/' + _to_bank + '/' + txn,
                type: "GET",
                async: false,
                dataType: "text",
                complete: function (data) {
...
function displayBlock() {
    ...
    */
    ...
    var res = $.ajax({
        type: "GET",
        url: 'http://127.0.0.1:3004/queryBlock/' + txseq + '/' + txhash1 + '/' + blocknum1 + '/'  + txhash2 + '/' + blocknum2 +'/'
